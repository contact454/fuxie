...
const ACHIEVEMENTS: AchievementSeed[] = [
    ...
    // Pilot mastery badges. These persist evidence only; no XP bonus is granted in the pilot.
    { slug: 'first-quest', title: 'Quest dau tien', titleDe: 'Erste Quest', description: 'Hoan thanh mot hoat dong hoc co y nghia.', descriptionDe: 'Eine sinnvolle Lernaktivitaet abgeschlossen.', category: 'learning', conditionType: 'pilot_badge', conditionValue: 0, xpReward: 0 },
    { slug: 'three-day-return', title: 'Quay lai 3 ngay', titleDe: 'Drei-Tage-Rueckkehr', description: 'Hoc trong 3 ngay khac nhau de tao nhip quay lai.', descriptionDe: 'An drei verschiedenen Tagen gelernt.', category: 'retention', conditionType: 'pilot_badge', conditionValue: 0, xpReward: 0 },
    { slug: 'srs-recovery', title: 'SRS Recovery', titleDe: 'SRS Recovery', description: 'On SRS du nhip de keo lai tri nho dai han.', descriptionDe: 'SRS-Wiederholung fuer langfristiges Behalten.', category: 'retention', conditionType: 'pilot_badge', conditionValue: 0, xpReward: 0 },
    { slug: 'vocabulary-starter', title: 'Tu vung Starter', titleDe: 'Wortschatz Starter', description: 'Hoan thanh 2 quest tu vung dau tien.', descriptionDe: 'Zwei Wortschatz-Quests abgeschlossen.', category: 'skill', conditionType: 'pilot_badge', conditionValue: 0, xpReward: 0 },
    { slug: 'grammar-starter', title: 'Ngu phap Starter', titleDe: 'Grammatik Starter', description: 'Hoan thanh 2 quest ngu phap dau tien.', descriptionDe: 'Zwei Grammatik-Quests abgeschlossen.', category: 'skill', conditionType: 'pilot_badge', conditionValue: 0, xpReward: 0 },
    { slug: 'listening-starter', title: 'Nghe Starter', titleDe: 'Hoeren Starter', description: 'Hoan thanh 2 quest nghe dau tien.', descriptionDe: 'Zwei Hoer-Quests abgeschlossen.', category: 'skill', conditionType: 'pilot_badge', conditionValue: 0, xpReward: 0 },
    { slug: 'reading-starter', title: 'Doc Starter', titleDe: 'Lesen Starter', description: 'Hoan thanh 2 quest doc dau tien.', descriptionDe: 'Zwei Lese-Quests abgeschlossen.', category: 'skill', conditionType: 'pilot_badge', conditionValue: 0, xpReward: 0 },
    { slug: 'writing-starter', title: 'Viet Starter', titleDe: 'Schreiben Starter', description: 'Hoan thanh 2 quest viet dau tien.', descriptionDe: 'Zwei Schreib-Quests abgeschlossen.', category: 'skill', conditionType: 'pilot_badge', conditionValue: 0, xpReward: 0 },
    { slug: 'speaking-starter', title: 'Noi Starter', titleDe: 'Sprechen Starter', description: 'Hoan thanh 2 quest noi dau tien.', descriptionDe: 'Zwei Sprech-Quests abgeschlossen.', category: 'skill', conditionType: 'pilot_badge', conditionValue: 0, xpReward: 0 },
    { slug: 'balanced-learner', title: 'Balanced Learner', titleDe: 'Balanced Learner', description: 'Cham nhieu ky nang de khong chi san diem o mot cho.', descriptionDe: 'Mehrere Skills mit sinnvoller Lernaktivitaet beruehrt.', category: 'learning', conditionType: 'pilot_badge', conditionValue: 0, xpReward: 0 },
    { slug: 'comeback', title: 'Comeback', titleDe: 'Comeback', description: 'Quay lai hoc sau mot quang nghi.', descriptionDe: 'Nach einer Pause wieder gelernt.', category: 'retention', conditionType: 'pilot_badge', conditionValue: 0, xpReward: 0 },
    { slug: 'exam-prep', title: 'Exam Prep', titleDe: 'Pruefungsvorbereitung', description: 'Hoan thanh cac quest luyen thi co y nghia.', descriptionDe: 'Sinnvolle Pruefungsquests abgeschlossen.', category: 'exam', conditionType: 'pilot_badge', conditionValue: 0, xpReward: 0 },
]
