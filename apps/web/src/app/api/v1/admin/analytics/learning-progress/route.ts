...
import { getLearningProgressReadout } from '@/lib/analytics/learning-progress-readout'
...
export async function GET(req: NextRequest) {
    ...
    const parsed = learningProgressQuerySchema.safeParse({
    ...
    const readout = await getLearningProgressReadout({ from, to })
