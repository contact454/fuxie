...
import { getActivationReadout } from '@/lib/analytics/activation-readout'
...
export async function GET(req: NextRequest) {
    ...
    const parsed = activationQuerySchema.safeParse({
    ...
    const readout = await getActivationReadout({ from, to })
