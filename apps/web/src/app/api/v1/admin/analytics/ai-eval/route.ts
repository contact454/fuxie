...
import { getAiEvalReadout } from '@/lib/analytics/ai-eval-readout'

const aiEvalQuerySchema = z.object({
...
export async function GET(req: NextRequest) {
    ...
    const parsed = aiEvalQuerySchema.safeParse({
    ...
    const readout = await getAiEvalReadout({ from, to })
