...
export default function AiCostsClient({ totalTokensAllTime, totalCostAllTime, chartData }: AiCostsClientProps) {
  return (
    <div className="p-6 md:p-8 space-y-6 max-w-7xl mx-auto">
      <div>
        <h1 className="text-2xl font-bold text-slate-900 tracking-tight">{"AI Compute & Usage" /* // locale-allow */}</h1>
        <p className="text-slate-500 mt-1">{"Monitor Gemini/Gemma token ingestion and estimated" /* // locale-allow */} financial impact.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white border border-slate-200 rounded-2xl p-6 flex flex-col justify-center items-center text-center shadow-sm">
          ...
          <h3 className="text-sm font-medium text-slate-500">{"Total Tokens Processed" /* // locale-allow */}</h3>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 flex flex-col justify-center items-center text-center shadow-sm">
          ...
          <h3 className="text-sm font-medium text-slate-500">{"Estimated Cost (USD)" /* // locale-allow */}</h3>
          <p className="text-3xl font-bold text-slate-900 mt-2">${totalCostAllTime.toFixed(4)}</p>
          <p className="text-xs text-slate-400 mt-2">{"Based on Gemini Flash rate ($0.15/1M)" /* // locale-allow */}</p>
        </div>
      </div>
      ...
      <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-6 mt-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-base font-semibold text-slate-900">{"7-Day Ingestion Trend" /* // locale-allow */}</h2>
        </div>
