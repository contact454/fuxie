        ...
        <main className="flex min-h-[100dvh] items-center justify-center bg-gradient-to-br from-fuxie-primary/5 via-white to-fuxie-secondary/5">
            <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-xl">
                ...
                <div className="mb-8 text-center">
                    ...
                    <p className="mt-2 text-gray-500">{t('register.journeyBegins')}</p>
                </div>
                ...
                <form onSubmit={handleRegister} className="space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full rounded-lg border border-gray-300 px-4 py-2.5 transition-colors focus:border-fuxie-primary focus:outline-none focus:ring-2 focus:ring-fuxie-primary/20"
                            placeholder={t('register.passwordMinLength')}
                            minLength={6}
                            required
                        />
                    </div>
                    ...
                    <div className="rounded-lg bg-gray-50 p-3">
                        <p className="mb-2 text-xs font-medium text-gray-500">{t('register.targetLevel')}</p>
...
async function loadFirebaseAuth() {
    const [{ getFirebaseAuth }, firebaseAuth] = await Promise.all([
