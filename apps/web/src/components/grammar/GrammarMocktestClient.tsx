...
const TheoryRenderer = dynamic(() => import('@/components/grammar/TheoryRenderer').then(mod => mod.TheoryRenderer), {
  ssr: false,
  loading: () => <div className={s.theoryCard} />,
})

const ExerciseRenderer = dynamic(() => import('@/components/grammar/ExerciseRenderer').then(mod => mod.ExerciseRenderer), {
  ssr: false,
  loading: () => <div className={s.exerciseCard} />,
})

const FeedbackToast = dynamic(() => import('@/components/grammar/ExerciseRenderer').then(mod => mod.FeedbackToast), {
  ssr: false,
})
