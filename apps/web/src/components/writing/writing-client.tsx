...
function getTeilIcon(textType: string): string {
    return TEIL_ICONS[textType] || TEIL_ICONS['default']!
}
                                        ...
                                        <div className="border-t border-gray-100 pt-3 space-y-2">
                                            {teil.exercises.map((ex, idx) => {
                                                ...
                                                const scoreDisplay = isDone
                                                    ? `${ex.completion!.bestScore}/${ex.completion!.maxScore}`
                                                    : null
