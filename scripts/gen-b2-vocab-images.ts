/**
 * B2 Vocabulary Image Generator + JSON Updater
 * Reads all A2 theme JSON files, generates images, and updates JSON with imageUrl
 * 
 * Uses Gemini API with fallback chain:
 *   gemini-3.1-flash-image-preview → gemini-2.5-flash-image
 *
 * Usage:
 *   npx tsx scripts/gen-a2-vocab-images.ts                # all themes
 *   npx tsx scripts/gen-a2-vocab-images.ts --theme=01     # specific theme
 *   npx tsx scripts/gen-a2-vocab-images.ts --start=06     # start from theme 06
 *   npx tsx scripts/gen-a2-vocab-images.ts --dry-run      # just list words
 */
...
async function main() {
    console.log('🦊 B2 Vocabulary Image Generator + JSON Updater')
    console.log('================================================')
