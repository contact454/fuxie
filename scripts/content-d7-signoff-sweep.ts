...
function validateRegister(register: D7Register): string[] {
  ...
  if (register.summary.vocabularyD7ReviewRows !== 914) errors.push(`expected 914 vocabulary D7 review rows, got ${register.summary.vocabularyD7ReviewRows}`)
  if (register.summary.vocabularyD7P1Rows !== 40) errors.push(`expected 40 vocabulary D7 P1 rows, got ${register.summary.vocabularyD7P1Rows}`)
