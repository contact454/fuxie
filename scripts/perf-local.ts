...
const targets: PerfTarget[] = [
    ...
    { name: 'Learner course modules', path: '/course?level=A1', role: 'learner', budgetMs: 800, mustContain: '<!DOCTYPE html>' },
    ...
    { name: 'Learner grammar module', path: '/grammar/a1-g01-alphabet-aussprache', role: 'learner', budgetMs: 800, mustContain: '<!DOCTYPE html>' },
    { name: 'Learner listening module', path: '/listening?level=A1', role: 'learner', budgetMs: 800, mustContain: '<!DOCTYPE html>' },
    { name: 'Learner reading module', path: '/reading?level=A1', role: 'learner', budgetMs: 800, mustContain: '<!DOCTYPE html>' },
    { name: 'Learner writing module', path: '/writing?level=A1', role: 'learner', budgetMs: 800, mustContain: '<!DOCTYPE html>' },
    { name: 'Learner speaking module', path: '/speaking?level=A1', role: 'learner', budgetMs: 800, mustContain: '<!DOCTYPE html>' },
    { name: 'Learner reading exercise', path: '/reading/A1-T1-001', role: 'learner', budgetMs: 900, mustContain: '<!DOCTYPE html>' },
    { name: 'Learner listening lesson', path: '/listening/L-A1-GOETHE-001-T1', role: 'learner', budgetMs: 900, mustContain: '<!DOCTYPE html>' },
    { name: 'Learner writing exercise', path: '/writing/W-A1-T1-001', role: 'learner', budgetMs: 900, mustContain: '<!DOCTYPE html>' },
    { name: 'Learner vocabulary practice detail', path: '/vocabulary/practice/mixed?theme=a1-person&level=A1', role: 'learner', budgetMs: 900, mustContain: '<!DOCTYPE html>' },
    { name: 'Learner daily session', path: '/session', role: 'learner', budgetMs: 900, mustContain: '<!DOCTYPE html>' },
    { name: 'Learner exam', path: '/exam', role: 'learner', budgetMs: 900, mustContain: '<!DOCTYPE html>' },
