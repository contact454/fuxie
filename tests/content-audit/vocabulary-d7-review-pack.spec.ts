...
describe('vocabulary D7 review pack', () => {
  it('covers the full vocabulary inventory and the remaining human-review dimensions', () => {
    ...
    expect(pack.summary.reviewItems).toBe(914)
    expect(pack.summary.byPriority).toEqual({ P1: 40, P2: 443, P3: 431 })
    expect(pack.summary.byFlag.plural_morphology_pending).toBe(344)
