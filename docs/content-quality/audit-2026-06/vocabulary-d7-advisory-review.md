...
- 139 bang chia dong tu hiem van co `auto_generated_needs_spot_check`.
...
Objective blockers trong dot nay dat muc machine-clean va co regression guard. Vocabulary chua du dieu kien goi la release-signed cho den khi 139 dong tu con lai, plural morphology, nghia/vi du va CEFR fit duoc reviewer chuyen mon duyet, sau do cap nhat signoff manifest.
