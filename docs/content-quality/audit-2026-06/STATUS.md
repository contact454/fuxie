...
- `node scripts/content-d7-signoff-sweep.ts`: **36/36 cell** trong D7 register, **120 review inputs** (60 human spot-check + D2 24 + D3 24 + D4 12) + **914 Vocabulary D7 review rows** (40 P1), **0 missing sample file**.
