...
- Vocabulary D7 advisory: 369/369 files and 10,461 entries checked; 221 files remediated for objective schema, lexeme, semantic, and present-conjugation blockers and guarded by `vocabulary-d7-readiness.spec.ts`. 139 rare conjugations and final native review remain pending.
