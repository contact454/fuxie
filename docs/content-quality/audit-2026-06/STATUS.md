...
- Vocabulary D7 advisory: 369/369 files and 10,461 entries checked; 239 files carry D7 remediation notes for objective schema, lexeme, semantic, and present-conjugation blockers and are guarded by `vocabulary-d7-readiness.spec.ts`. 2 rare conjugations (`silencen`, `entbergen`) and final native review remain pending.
