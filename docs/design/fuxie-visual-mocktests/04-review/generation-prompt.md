# Generation Prompt — 04-review

## Visual intent
Flip-card stack ready for spaced review — patient, restorative

## Module identity cues
Card flip stack center với queue rail, palette amber + soft mint, prop flip card xác định module review
...
Module: 04-review. Visual intent: Flip-card stack ready for spaced review — patient, restorative. Identity cues: Card flip stack center với queue rail, palette amber + soft mint, prop flip card xác định module review.

Render three viewports as separate images:
- Mock_Desktop viewport 1440×900 px: Spaced review queue với card hiện tại, navigation đầy đủ, vùng nội dung chính ≥ 60% chiều rộng viewport, đúng 1 CTA chính enabled, ít nhất 1 dấu hiệu Module_Identity (logo / tên module / icon đặc trưng "flip card") trong vùng nhìn đầu.
...
- Mock_State: empty state — không có item cần ôn. Module_Identity vẫn nhận diện được. Nếu là error state, phải có thông điệp lỗi đầy đủ + ≥ 1 lối thoát (retry/back/contact).
