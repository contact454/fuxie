...
| P19-A3 | P2 | Add GitHub Actions Node 20 deprecation follow-up | DevOps / Cloud Engineer | CTO / Tech Lead, QA Automation Engineer | Implemented in Phase 22 pending PR CI; workflow opts JavaScript actions into Node 24 before GitHub's default change |
...
3. Add `FORCE_JAVASCRIPT_ACTIONS_TO_NODE24: true` at workflow level.
